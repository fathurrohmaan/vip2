...
echo -e "  Auther : ${green} fathurrohman vpn® ${NC}${YELLOW}(${NC} ${green} Fathurrohman vpn Tunneling ${NC}${YELLOW})${NC}"
echo -e " © Recode By Fathurrohman Tunneling${YELLOW}(${NC} 2024 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
###### IZIN SC 
...
# USERNAME
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/fathurrohmaan/vip2/main/izin | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/fathurrohmaan/vip2/main/izin | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
# DETAIL ORDER
...
Exp1=$(curl https://raw.githubusercontent.com/fathurrohmaan/vip2/main/izin | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/fathurrohmaan/vip2/main/"
...
wget raw.githubusercontent.com/fathurrohmaan/vip2/main/limit/limit.sh && chmod +x limit.sh && ./limit.sh
